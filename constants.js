exports.constants = {
	...
	QUERIES: {
		...
		CREATETABLE: "create table if not exists {DBNAME}.{TABLENAME}(userid int auto_increment, username varchar(100) not null, urlkey varchar(255) not null, primary key(userid));",
